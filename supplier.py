...
class supplierClass:
    def __init__(self,root):
        ...
        #======options==============
        lbl_search=Label(self.root,text="Invoice No.",bg="white",font=("gouldy old style",15))
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Addedd Succefully", parent=self.root)
                    self.show()
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Updated Succefully", parent=self.root)
                    self.show()
            ...
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete", "Supplier Deleted Succefully", parent=self.root)
                        self.show()
