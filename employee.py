...
class employeeClass:
    def __init__(self,root):
        ...
        #======options==============
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state='readondly',justify=CENTER,font=("time new roman",15))
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Other"),state='readondly',justify=CENTER,font=("time new roman",15))
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state='readondly',justify=CENTER,font=("time new roman",15))
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Employee Addedd Succefully", parent=self.root)
                    self.show()
            ...
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete", "Employee Deleted Succefully", parent=self.root)
                        self.show()
