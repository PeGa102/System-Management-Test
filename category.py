...
class categoryClass:
    def __init__(self,root):
        ...
        #=====Images======
        self.im1=Image.open("Logo/Free Business Environment Illustration.png")
        ...
        self.im2=Image.open("Logo/Free Office Environment Illustration-PNG.png")
        ...
        try:
            if self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Category Addedd Succefully", parent=self.root)
                    self.show()
            ...
            if self.var_cat_id.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete", "Category Deleted Succefully", parent=self.root)
                        self.show()
                        self.var_cat_id.set("")
                        self.var_name.set("")
